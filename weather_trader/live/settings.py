...
class LiveSettings:
    ...
    live_max_usd_per_order: float = 50.0
    live_max_exposure_per_station_date: float = 125.0
    live_max_exposure_per_station_date_side: float = 85.0
    live_max_exposure_per_exact_bucket_side: float = 50.0
    live_max_total_open_risk: float = 450.0
    live_max_daily_new_risk: float = 300.0
...
def load_live_settings() -> LiveSettings:
    ...
    return LiveSettings(
        ...
        live_max_usd_per_order=_float_env("LIVE_MAX_USD_PER_ORDER", 50.0),
        live_max_exposure_per_station_date=_float_env("LIVE_MAX_EXPOSURE_PER_STATION_DATE", 125.0),
        live_max_exposure_per_station_date_side=_float_env("LIVE_MAX_EXPOSURE_PER_STATION_DATE_SIDE", 85.0),
        live_max_exposure_per_exact_bucket_side=_float_env("LIVE_MAX_EXPOSURE_PER_EXACT_BUCKET_SIDE", 50.0),
        live_max_total_open_risk=_float_env("LIVE_MAX_TOTAL_OPEN_RISK", 450.0),
        live_max_daily_new_risk=_float_env("LIVE_MAX_DAILY_NEW_RISK", 300.0),
