...
4. Confirm that the question remains open. Close it instead of continuing if the durable output already exists and satisfies the closure condition.
5. Keep the thread's next action current whenever work changes direction.
