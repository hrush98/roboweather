...
- Active US high-temperature markets identify Weather Underground station history pages as their resolution sources. Current weather-outcome scoring is therefore a proxy until source equivalence is demonstrated.
