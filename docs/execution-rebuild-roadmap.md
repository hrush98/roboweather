...
| F. Full-lifecycle forecast/data foundation | Observe weather and market state from first listing and price horizon-specific distributions. | Corrected US-high F3, F4, and F6 rejected; F5 and four-cohort FC0 are next-ready research; global-high, US-low, and global-low truth/models remain gated; no production consumer | Each cohort has venue-aligned truth, causal sources, coherent high/low distributions, hierarchical station validation, horizon calibration, and its own F6 evidence. |
