...
| F. Full-lifecycle forecast/data foundation | Observe weather and market state from first listing and price horizon-specific distributions. | US-high F3 accepted for pricing research, F4 rejected, and F5 next; F6 and four-cohort FC0 ready; global-high, US-low, and global-low truth/models remain gated; no production consumer | Each cohort has venue-aligned truth, causal sources, coherent high/low distributions, hierarchical station validation, horizon calibration, and its own F6 evidence. |
