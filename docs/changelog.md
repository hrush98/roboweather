...
- Updated the adverse-selection rebuild plan to distinguish tiny quote canaries from capacity evidence: `$2-$5` funded quotes are plumbing tests only, while `$25` and `$50` quote canaries are required before normal-size promotion evidence.
