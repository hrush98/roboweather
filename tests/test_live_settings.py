...
def test_live_sizing_defaults() -> None:
    ...
    assert settings.live_max_usd_per_order == 100
    assert settings.live_max_exposure_per_station_date == 300
    assert settings.live_max_exposure_per_station_date_side == 200
    assert settings.live_max_exposure_per_exact_bucket_side == 100
    assert settings.live_max_total_open_risk == 1125
    assert settings.live_max_daily_new_risk == 750
