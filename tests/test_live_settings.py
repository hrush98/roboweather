...
def test_live_sizing_defaults() -> None:
    ...
    assert settings.live_max_usd_per_order == 50
    assert settings.live_max_exposure_per_station_date == 125
    assert settings.live_max_exposure_per_station_date_side == 85
    assert settings.live_max_exposure_per_exact_bucket_side == 50
    assert settings.live_max_total_open_risk == 450
    assert settings.live_max_daily_new_risk == 300
